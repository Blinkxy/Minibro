...
LRFLAG = -L/Users/mdouzi/goinfre/homebrew/opt/readline/lib -I/Users/mdouzi/goinfre/homebrew/opt/readline/include
RM = rm -rf
...
builtins/ft_echo.c builtins/export_utils_2.c builtins/export_utils.c builtins/ft_export.c builtins/ft_env.c builtins/ft_pwd.c builtins/cd_utils.c \
builtins/ft_cd.c excutions/heredoc.c excutions/pipe.c excutions/ex.c excutions/redirections.c initializers.c excutions/handler.c\
