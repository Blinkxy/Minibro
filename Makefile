...
builtins/ft_cd.c builtins/export_utils_2.c excutions/pipe.c excutions/handle_fd.c excutions/ex.c excutions/heredoc.c excutions/redirections.c initializers.c excutions/handler.c\
...
$(NAME): $(OBJ)
	@make -C libft
	@$(CC)  $(OBJ) -o $(NAME) $(LIBFT_A) $(LRFLAG) -L/Users/mzoheir/goinfre/homebrew/opt/readline/lib -I/Users/mzoheir/goinfre/homebrew/opt/readline/include -lreadline #-fsanitize=address
